      ...
      <main className="mx-auto max-w-6xl px-4 py-8">
        <div className="flex items-end justify-between gap-4 flex-wrap">
          <div>
            ...
            <p className="text-sm text-slate-600 mt-1">Crea registros y consulta por identificación.</p>
          </div>
        ...
        <div className="grid md:grid-cols-3 gap-4 mt-6">
          <Card className="p-5">
            ...
            <div className="text-xs text-slate-500 mt-1">Busca por identificación y revisa historial.</div>
            <Button variant="ghost" className="mt-4" onClick={() => nav("/buscar")}>Ir a buscar →</Button>
          </Card>
          <Card className="p-5">
            <div className="text-sm font-semibold text-slate-700">Registro</div>
            <div className="text-xs text-slate-500 mt-1">Guarda una nueva orientación en el repositorio.</div>
          ...
          <Card className="p-5">
            ...
            <div className="mt-4 text-xs text-slate-500">Configura <code className="px-1 rounded bg-slate-100">VITE_API_BASE</code> si aplica.</div>
          </Card>
        </div>
      </main>
    </div>
